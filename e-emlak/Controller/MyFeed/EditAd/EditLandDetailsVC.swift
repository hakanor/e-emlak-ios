...
class EditLandDetailsVC: UIViewController{
    ...
    @objc func handleNextButton(){
        ...
        if checkTextFields() != "" {
            ...
            let dict = [
                ...
                "price":price,
                "squareMeter":meter,
                "pricePerSquareMeter": (Double(price) ?? 0) / (Double(meter) ?? 0),
                "blockNumber" : Int(blockNumber) ?? 0,
                "parcelNumber" : Int(parcelNumber) ?? 0,
            ] as [String : Any]
    ...
    private func setData(){
        ...
        self.parcelNumberTextField.text = String(self.ad.parcelNumber)
        self.blockNumberTextField.text = String(self.ad.blockNumber)
    ...
    private func checkTextFields() -> String {
        ...
        guard parcelNumberTextField.text != "" else { return "Parsel numarası alanı boş olamaz."}
        guard blockNumberTextField.text != "" else { return "Ada numarası alanı boş olamaz."}
...
extension EditLandDetailsVC: PHPickerViewControllerDelegate {
...
extension EditLandDetailsVC: UICollectionViewDataSource, UICollectionViewDelegate {
