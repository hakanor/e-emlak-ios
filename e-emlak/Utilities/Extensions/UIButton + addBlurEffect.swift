//
//  UIButton + addBlurEffect.swift
//  e-emlak
//
//  Created by Hakan Or on 11.12.2022.
//
...
extension UIButton {
    func addBlurEffect(style: UIBlurEffect.Style = .regular, cornerRadius: CGFloat = 0, padding: CGFloat = 0) {
        ...
        self.leadingAnchor.constraint(equalTo: blurView.leadingAnchor, constant: padding + 1).isActive = true
        self.trailingAnchor.constraint(equalTo: blurView.trailingAnchor, constant: -padding - 1).isActive = true
